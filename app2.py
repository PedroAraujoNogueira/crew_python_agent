...
from Tools.search_tools import search_internet  # Importando a função de busca
...
# Verificar se as chaves de API foram carregadas corretamente
...
researcher = Agent(
    ...
    tools=[search_internet]  # Usando a função de busca
)
...
OpenAIGPT4Mini = ChatOpenAI(
    model="gpt-4o-mini",  # Corrigido: o nome correto do modelo é gpt-4o-mini
    temperature=0.7
)
