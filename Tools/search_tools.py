...
# Importa a classe Tool do CrewAI para criar ferramentas compatíveis
from crewai.tools import tool as crewai_tool

# Define uma função com o decorator @crewai_tool do CrewAI
@crewai_tool("Search the internet")
